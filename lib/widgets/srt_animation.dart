...
class SRTAnimationWidget extends StatefulWidget {
  final List<AnimationStep> steps;
  const SRTAnimationWidget({super.key, required this.steps});

  @override
  State<SRTAnimationWidget> createState() => _SRTAnimationWidgetState();
}

class _SRTAnimationWidgetState extends State<SRTAnimationWidget> {
  int currentStep = 0;
